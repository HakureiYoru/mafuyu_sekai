...
export const BALANCE = {
  player: { speed: 300, radius: 18, hp: 5, bombs: 3, hitInvincible: 40 / 60 },
  dash: { speed: 1080, duration: 0.18, cooldown: 3, window: 0.65, damage: 40, targets: 180, beamLength: 2400, beamWidth: 88, beamDuration: 0.32 },
  ...
  spawn: { intervals: [1.1, 1, 0.9, 0.8, 0.75], warning: 0.8, waveDuration: 60, storyWaves: 5, endlessBossInterval: 10 },
  boss: { hp: 1800, radius: 160, speed: 30, laserWarning: 1.2, laserLock: 0.4, laserWidth: 96, laserLength: 6000, laserDuration: 3.5, angularSpeed: 0.55, laserCooldown: 14, firstLaser: 10, addInterval: 6, maxAdds: 8, patternGap: 0.6 },
